...
const file_hello_hello_proto_rawDesc = "" +
	"\n" +
	"\x11hello/hello.proto\x12\tapi.hello\x1a\x1cgoogle/api/annotations.proto\x1a google/protobuf/descriptor.proto\"\"\n" +
	...
	"\x05hello\x12T\n" +
	"\tpinghello\x12\x17.api.hello.HelloRequest\x1a\x15.api.hello.HelloReply\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*b\x01*\"\tpinghelloB\x13Z\x11agdemoA/api/hellob\x06proto3"
...
var file_hello_hello_proto_goTypes = []any{
	...
	(*HelloReply)(nil),   // 1: api.hello.HelloReply
}
var file_hello_hello_proto_depIdxs = []int32{
	0, // 0: api.hello.hello.pinghello:input_type -> api.hello.HelloRequest
	1, // 1: api.hello.hello.pinghello:output_type -> api.hello.HelloReply
