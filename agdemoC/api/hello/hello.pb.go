...
const file_hello_hello_proto_rawDesc = "" +
	...
	"\x05hello\x12T\n" +
	"\tpinghello\x12\x17.api.hello.HelloRequest\x1a\x15.api.hello.HelloReply\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*b\x01*\"\tpinghelloB\x13Z\x11agdemoC/api/hellob\x06proto3"
